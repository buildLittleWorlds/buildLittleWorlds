...
| 5 | [The Densworld Oracle](https://github.com/buildLittleWorlds/densworld-oracle) | RAG pipelines with LlamaIndex, domain-specific LLM | 10 |
| 6 | [The Wanderer's Experiments](https://github.com/buildLittleWorlds/wanderer-experiments) | Model evaluation, benchmarking, adapting to new releases | 8 |
| Meta | [The Noise and the Signal](https://github.com/buildLittleWorlds/noise-and-signal) | Extract structured data from messy text (3 tracks) | 11+ |
...
Every course uses **narrative framing** to create stakes. You're not just cleaning a CSV—you're an apprentice archivist whose mistakes "have gotten trappers killed." Technical concepts get semantic anchors: gradient descent becomes The Colonel's 20-year siege; dot products measure similarity between philosophical schools.

All notebooks run in Google Colab with one click. No local setup required.

---

## About Me

I research and publish on AI integration in humanities education. Recent work includes:
...
- *Mind, Machine, and Will: Determinism, Responsibility, and Agency in the Age of AI* (Nova Science, 2025)
- *Generative AI in the English Composition Classroom* (Routledge, 2024)

I teach applied AI courses in Lindenwood's Human-Centered AI program and have 20+ years of experience teaching writing, literature, and world-building.

**Contact:** DPlate@lindenwood.edu

---

*These courses are independent personal projects, not institutional materials. All views and intellectual property are my own.*
